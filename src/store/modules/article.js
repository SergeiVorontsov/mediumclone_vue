...
const actions = {
    [actionTypes.getArticle](context, {slug}) {
        return new Promise(resolve => {
            context.commit(mutationTypes.getArticleStart, slug) // get slug in payload to easy debug
            articleApi
                .getArticle(slug)
                .then(article => {
    ...
    [actionTypes.deleteArticle](context, {slug}) {
        return new Promise(resolve => {
            context.commit(mutationTypes.deleteArticleStart, slug) // get slug in payload to easy debug
            articleApi
                .deleteArticle(slug)
                .then(() => {
